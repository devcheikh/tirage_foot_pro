<?php
// Direct database insertion script for demo players
...
try {
    ...
    if ($teamCount == 0) {
        ...
        echo "Équipes de démonstration créées.\n";
    }
    ...
    foreach ($players as $player) {
        try {
            ...
            echo "Erreur insertion joueur {$player['name']}: " . $e->getMessage() . "\n";
        }
    }

    echo "✅ $inserted joueurs de démonstration ajoutés avec succès !\n";
    echo "Ils sont maintenant visibles sur la page CV/Scouting.\n";
